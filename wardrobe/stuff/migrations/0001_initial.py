    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_set', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='stuff.set')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stuff.itemtemplate')),
            ],
        ),
    ]
